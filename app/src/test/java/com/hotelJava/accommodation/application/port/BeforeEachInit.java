...
public class BeforeEachInit {
    ...
    public void init() {
        ...
        // 룸
        Room room1 = Room.builder().name("1번 룸").price(1000).maxOccupancy(50).build();
        Room room2 = Room.builder().name("2번 룸").price(2000).maxOccupancy(50).build();
        Room room3 = Room.builder().name("3번 룸룸룸").price(30000).maxOccupancy(50).build();
