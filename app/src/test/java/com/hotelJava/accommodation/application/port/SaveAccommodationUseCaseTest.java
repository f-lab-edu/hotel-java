...
@SpringBootTest
@Transactional
public class SaveAccommodationUseCaseTest extends BeforeEachInit {

  @Autowired SaveAccommodationUseCase sut;
  ...
  void 숙소_등록() {
    ...
    CreateAccommodationResponseDto createAccommodationResponseDto =
        sut.saveAccommodation(createAccommodationRequestDto);
  ...
  void 숙소명_중복_확인() {
    ...
    // then
    assertThatThrownBy(() -> sut.saveAccommodation(createAccommodationRequestDto))
